...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.powerwashsimulator2.wiki'
  const path = '/about'

  return {
    title: 'About PowerWash Simulator 2 Wiki - Your Ultimate Steam Game Resource',
    description: 'Learn about PowerWash Simulator 2 Wiki, a community-driven resource hub providing comprehensive guides, crafting tips, creature info, and strategies for the PowerWash Simulator 2 Steam game.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      siteName: 'PowerWash Simulator 2 Wiki',
      title: 'About PowerWash Simulator 2 Wiki',
      description: 'Learn about our mission to provide the best PowerWash Simulator 2 game resources and guides.',
      images: [
        {
          url: `${siteUrl}/images/hero.webp`,
          width: 1200,
          height: 630,
          alt: 'PowerWash Simulator 2 Wiki',
        },
      ],
    },
    twitter: {
      ...
      title: 'About PowerWash Simulator 2 Wiki',
      description: 'Learn about our mission to provide the best PowerWash Simulator 2 game resources.',
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            About PowerWash Simulator 2 Wiki
          </h1>
          <p className="text-slate-300 text-lg mb-2">
            Your community-driven resource center for PowerWash Simulator 2
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Welcome to PowerWash Simulator 2 Wiki</h2>
            <p>
              PowerWash Simulator 2 Wiki is an <strong>unofficial, fan-made resource website</strong> dedicated to helping players
              master the Steam game "PowerWash Simulator 2". We are a community-driven platform that provides comprehensive guides,
            ...
            <p>
              ...
              PowerWash Simulator 2 Wiki is here to support you every step of the way.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Our Mission</h2>
            <p>
              Our mission is simple: <strong>to empower PowerWash Simulator 2 players with accurate, up-to-date information
            ...
            <h2>Our Vision</h2>
            <p>
              We envision PowerWash Simulator 2 Wiki as the <strong>go-to destination</strong> for every PowerWash Simulator 2 player seeking
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              ...
              <p className="text-slate-300">
                Step-by-step guides to unlock all 60 achievements in the game.
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              PowerWash Simulator 2 Wiki is built <strong>by the community, for the community</strong>. We welcome contributions,
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              PowerWash Simulator 2 Wiki is maintained by a dedicated team of passionate gamers and developers who love
              PowerWash Simulator 2 as much as you do. We're players first, constantly testing strategies, exploring game
            ...
            <ul>
              <li><strong>Game analysis:</strong> Deep understanding of PowerWash Simulator 2 mechanics and strategies</li>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-yellow-400/90">
              <strong>PowerWash Simulator 2 Wiki is an unofficial fan-made website.</strong> We are NOT affiliated with,
              endorsed by, or associated with the developers of PowerWash Simulator 2 or any official entities.
            </p>
            <p>
            ...
            <p>
              PowerWash Simulator 2 Wiki is a non-profit, community resource created by fans, for fans.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                ...
                <a href="mailto:contact@powerwashsimulator2.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contact@powerwashsimulator2.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Bug Reports</h3>
                <a href="mailto:support@powerwashsimulator2.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  support@powerwashsimulator2.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Content Submissions</h3>
                <a href="mailto:contribute@powerwashsimulator2.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contribute@powerwashsimulator2.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Partnerships</h3>
                <a href="mailto:partnerships@powerwashsimulator2.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  partnerships@powerwashsimulator2.wiki
                </a>
              </div>
            </div>
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-y border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
            Stay updated with the latest guides, tips, and PowerWash Simulator 2 news.
